  ...
  // General Settings Group
  {
    ...
    fields: [
      ...
      },
      {
        ...
        scope: 'installation',
        defaultValue: 30,
        helpText: 'Backup scheduler for missed items. Small subs (<50k): 60 min. Medium (50k-500k): 30 min. Large (500k+): 15 min. Range: 15-60.',
      },
      {
        ...
        scope: 'installation',
        defaultValue: 30,
        helpText: 'How often to send batched notifications. Small subs: 60-120s. Medium: 30-60s. Large/high-traffic: 15-30s. Range: 15-120.',
      },
    ],
  },
    ...
    fields: [
      {
        ...
        scope: 'installation',
        defaultValue: 45,
        helpText: 'Items older than this are marked stale. Small subs: 60-120 min. Medium: 30-60 min. Large: 15-45 min.',
      },
      {
        ...
        scope: 'installation',
        defaultValue: 5,
        helpText: 'Alert when queue exceeds this count. Small subs: 3-5. Medium: 5-10. Large (500k+): 10-25. Very large: 25-50.',
      },
    ],
  },
